...
entity generic_shifter is
    ...
    port (
        ...
        func : in std_logic_vector(1 downto 0); -- type of shift
...
begin
    ...
    with shamt(0) & func select 
        sGen(0) <= din(0) & din(2**shift_bits-1) & din(2**shift_bits-1 downto 1) when "111",
                   din(0) & '0' & din(2**shift_bits-1 downto 1) when "110",
                   din(2**shift_bits-1) & din(2**shift_bits-2 downto 0) & '0' when "101",
    ...
    gen_shift: for I in 1 to shift_bits-1 generate
        with shamt(I) & func select 
            sGen(I) <= sGen(I-1)(2**I-1)                       & (2**I-1 downto 0 => sGen(I-1)(2**shift_bits-1))  & sGen(I-1)(2**shift_bits-1 downto 2**I) when "111",
                       sGen(I-1)(2**I-1)                       & (2**I-1 downto 0 => '0')                         & sGen(I-1)(2**shift_bits-1 downto 2**I) when "110",
                       sGen(I-1)((2**shift_bits)-(2**I)) & sGen(I-1)((2**shift_bits-1)-(2**I) downto 0)     & (2**I-1 downto 0 => '0')               when "101",
