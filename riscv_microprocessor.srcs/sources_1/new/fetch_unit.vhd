...
entity fetch_unit is
	...
	port (
	   ...
	   Error	    : out std_logic; -- Asserts when ERROR is detected
		...
		M_AXI_AWUSER	: out std_logic; -- Optional User-defined signal in the write address channel.
		...
		M_AXI_WUSER	    : out std_logic; -- Optional User-defined signal in the write data channel.
		...
		M_AXI_BUSER	    : in std_logic; -- Optional User-defined signal in the write response channel
		...
		M_AXI_ARUSER	: out std_logic; -- Optional User-defined signal in the read address channel.
		...
		M_AXI_RUSER	    : in std_logic; -- Optional User-defined signal in the read address channel.
