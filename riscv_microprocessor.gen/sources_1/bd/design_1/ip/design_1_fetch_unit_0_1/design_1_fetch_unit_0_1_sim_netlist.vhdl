...
entity design_1_fetch_unit_0_1_generic_register is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_fetch_unit_0_1_generic_register : entity is "generic_register";
end design_1_fetch_unit_0_1_generic_register;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_fetch_unit_0_1_fetch_unit is
  port (
...
end design_1_fetch_unit_0_1_fetch_unit;

architecture STRUCTURE of design_1_fetch_unit_0_1_fetch_unit is
...
begin
IRLatch: entity work.design_1_fetch_unit_0_1_generic_register
     port map (
      E(0) => E(0),
...
entity design_1_fetch_unit_0_1 is
  ...
  attribute NotValidForBitStream of design_1_fetch_unit_0_1 : entity is true;
  ...
  attribute x_core_info of design_1_fetch_unit_0_1 : entity is "fetch_unit,Vivado 2025.1";
