...
REM
REM Generated by Vivado on Fri Sep 26 16:33:09 -0600 2025
...
echo "xvhdl --incr --relax -prj RISCV_Inst_Dec_tb_vhdl.prj"
call xvhdl  --incr --relax -prj RISCV_Inst_Dec_tb_vhdl.prj -log xvhdl.log
