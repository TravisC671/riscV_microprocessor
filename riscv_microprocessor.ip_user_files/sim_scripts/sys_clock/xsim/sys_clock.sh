...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L dist_mem_gen_v8_0_17 -L axi_traffic_gen_v3_0_21 -L proc_sys_reset_v5_0_17 -L xlconstant_v1_1_10 -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_35 -L axi_vip_v1_1_21 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sys_clock xil_defaultlib.sys_clock xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim sys_clock -key {Behavioral:sim_1:Functional:sys_clock} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_f78a.protoinst" -protoinst "protoinst_files/sys_clock.protoinst" -protoinst "protoinst_files/bd_919a.protoinst" -protoinst "protoinst_files/system.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sys_clock.wdb xsim.dir libdpi.so)
