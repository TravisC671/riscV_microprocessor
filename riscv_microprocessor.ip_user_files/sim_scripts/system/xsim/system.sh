...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L smartconnect_v1_0 -L axi_protocol_checker_v2_0_21"
...
simulate()
{
  xsim system -key {Behavioral:sim_1:Functional:system} -tclbatch cmd.tcl -protoinst "protoinst_files/system.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
