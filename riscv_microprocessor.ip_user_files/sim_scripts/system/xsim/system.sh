...
simulate()
{
  xsim system -key {Behavioral:sim_1:Functional:system} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_919a.protoinst" -protoinst "protoinst_files/system.protoinst" -protoinst "protoinst_files/bd_f78a.protoinst" -protoinst "protoinst_files/sys_clock.protoinst" -log simulate.log
}
