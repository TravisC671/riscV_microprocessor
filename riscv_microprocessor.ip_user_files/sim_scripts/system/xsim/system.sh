...
simulate()
{
  xsim system -key {Behavioral:sim_1:Functional:system} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_919a.protoinst" -protoinst "protoinst_files/system.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
